                ...
                <div class="d-flex flex-column align-items-center text-center">
                  ...
                  <div class="mt-3">
                    <h5>
                      ...
                      {{ store.studentList[store.userId].fullName }}
                    </h5>
            ...
            <div class="card mb-3 p-1">
              <div class="card-body p-3">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-9 text-secondary">
                    {{ store.studentList[store.userId].faculty }}
                  </div>
                </div>
                <hr />
                <div class="row">
                  <div class="col-sm-3">
                    <h6 class="mb-0">Academic Type</h6>
                  </div>
                  <div class="col-sm-9 text-secondary">
                    {{ store.studentList[store.userId].academicType }}
                  </div>
                </div>
                <hr />
                <div class="row">
