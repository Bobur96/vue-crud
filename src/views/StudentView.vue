                    ...
                    <div class="card-body" style="padding: 11px 13px">
                      <span class="row justify-content-between align-items-center">
                        <span class="col-md-4 col-9 color--heading">
                          <span
                            id="strong"
                            class="badge badge-circle background--danger text-white me-2"
                          >
                            {{name}}
                          </span>{{" "}}
                          {{fullName}}
                        ...
                        <span class="d-none d-md-block col-md-4 my-sm-0 color--text">
                          <i class="fa-solid fa-building-columns"></i>{{" "}}
                          {{universityName}}
                        </span>

                        <span class="d-none d-md-block col-md-2 my-sm-0 color--text">
                          {{academicType}}
                        </span>
